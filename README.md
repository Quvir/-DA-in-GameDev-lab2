...
- В игре предусмотрена награда за убийство 60 врагов на уровне без получения урона. Для этого существует счётчик убитых врагов без получения урон. Эта переменная и была взята для выполнения работы.
- Счётчик растёт при убийстве противников, если игрок получает урон, счётчик обнуляется. При достижении 60 убийств иконка счётчика меняется, что гарантирует получние награды даже при последующем получении урона.
